...
<body id="login">
  <!-- form Register -->
  <div class="center2">
    <!-- div dengan class center bertujuan untuk membuat posisi tag form yang akan dibuat akan menjadi rata tengah -->
    <div class="pb-2">
      <center>
        <h1><i class="fas fa-book" style="color: blue"> Register</i></h1>
      </center>
    </div>
    @error('name')
